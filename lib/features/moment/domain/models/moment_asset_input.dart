...
///
/// The presentation layer copies the picked file into app storage and probes
/// its dimensions/size, then hands this descriptor to the repository which only
/// inserts DB rows (it does no file I/O).
