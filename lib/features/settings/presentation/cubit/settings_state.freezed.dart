...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingsState&&(identical(other.themeMode, themeMode) || other.themeMode == themeMode)&&(identical(other.language, language) || other.language == language)&&(identical(other.notificationsEnabled, notificationsEnabled) || other.notificationsEnabled == notificationsEnabled)&&(identical(other.appLockEnabled, appLockEnabled) || other.appLockEnabled == appLockEnabled)&&(identical(other.keepMemoriesOffline, keepMemoriesOffline) || other.keepMemoriesOffline == keepMemoriesOffline)&&(identical(other.gentleReminders, gentleReminders) || other.gentleReminders == gentleReminders));
}


@override
int get hashCode => Object.hash(runtimeType,themeMode,language,notificationsEnabled,appLockEnabled,keepMemoriesOffline,gentleReminders);

@override
String toString() {
  return 'SettingsState(themeMode: $themeMode, language: $language, notificationsEnabled: $notificationsEnabled, appLockEnabled: $appLockEnabled, keepMemoriesOffline: $keepMemoriesOffline, gentleReminders: $gentleReminders)';
}
...
as bool,gentleReminders: null == gentleReminders ? _self.gentleReminders : gentleReminders // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@override@JsonKey() final  bool keepMemoriesOffline;
@override@JsonKey() final  bool gentleReminders;
